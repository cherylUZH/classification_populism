...
# best values
tune_res %>% select_best(metric = "accuracy") #mtry = 11 , min_n 7
...
best_auc <- select_best(regular_res, "roc_auc") # mtry = 14, min_n = 5
...
# write to disk
write_rds(final_wf, "~/Uni/Master/Masterarbeit/Results/Final Results/RF3_wf.rds")
...
# write to disk
write_rds(final_result, "~/Uni/Master/Masterarbeit/Results/Final Results/RF3_result.rds")
